...
**一个多系统桌面工具箱，整合文件、系统、网络和开发常用小工具；当前优先适配 Windows。**
...
项目基于 Tauri 的跨平台能力构建，不刻意限定为只能在 Windows 上使用。当前主要开发和测试环境仍是 Windows，部分功能依赖 Windows API，在其他桌面系统上可能需要单独适配或存在功能限制。
...
| 组件 | 要求 |
| --- | --- |
| 操作系统 | 当前优先测试 Windows 10 / 11；其他 Tauri 支持的桌面系统可能需要按功能适配 |
| Node.js | 20 或更高版本 |
| pnpm | 当前稳定版本 |
